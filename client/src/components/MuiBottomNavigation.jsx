...
export const MuiBottomNavigation = (e) => {
    const [value, setValue] = useState(0) 
    return (
    <BottomNavigation sx={{bgcolor: 'secondary.main', width: '100%', position: 'absolute', bottom: 0 }} value={value} onChange={(e, newValue) => { setValue(newValue); }} showLabels>
